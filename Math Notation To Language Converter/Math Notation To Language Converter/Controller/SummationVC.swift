...
class SummationVC: UIViewController, MSVCProtocol {              //Adopts Math Sequence View (MSV) Protocol (see 'MathSequence' Folder)
    ...
    var sequenceType: MathSequenceType = .summation
    ...
    override func viewDidLoad() {
        ...
        sequenceVariableTf.text = sequence.sequenceVariable //initialise views
